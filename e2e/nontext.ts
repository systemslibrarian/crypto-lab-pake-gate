...
export async function auditNonText(page: Page, within = 'body *'): Promise<NonTextFailure[]> {
  return page.evaluate((rootSelector) => {
     ...
     *
     * A driven pass here walks four protocol tabs, a five-row nine-column
     * taxonomy matrix, and — the expensive part — the on-path observer's raw
     * transcript, every field of every wire message in its own block, all
     ...
     * gradient anywhere, so the sampler is a no-op here today; it is kept
